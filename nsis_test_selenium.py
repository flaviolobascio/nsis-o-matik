...
class TestTest1(): 
  ...
  def test_test1(self):
    ...
    self.driver.find_element(By.NAME, "Ecom_User_ID").click()
    element = self.driver.find_element(By.NAME, "Ecom_User_ID")
    ...
    self.driver.find_element(By.ID, "ListingURE_detailView_listColumn_0_0_1").click()
    element = self.driver.find_element(By.ID, "ListingURE_detailView_listColumn_0_0_1")
    actions = ActionChains(self.driver)
    actions.double_click(element).perform()
    self.driver.switch_to.default_content()
