...
tasto_bo = wait.until(EC.visibility_of_element_located((By.XPATH, \
                        '/html/body/table[3]/tbody/tr[2]/td/table/tbody/tr[2]/td/table/tbody/tr[7]/td/img')))
...
for nome_tabella in nomi_tabelle:
    ...
    menu_documento = wait.until(EC.visibility_of_element_located((By.XPATH, '//*[@id="IconImg_Txt_iconMenu_icon_docMenu"]')))
